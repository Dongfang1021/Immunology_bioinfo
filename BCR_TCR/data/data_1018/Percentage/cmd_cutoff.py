...
for eachline in input:
    ...
    cmd = '''
    python cutoff_percentage.py --input %s --output %s --cutoff 0.1
    python cutoff_percentage.py --input %s --output %s --cutoff 0.2
    python cutoff_percentage.py --input %s --output %s --cutoff 0.3
    python cutoff_percentage.py --input %s --output %s --cutoff 0.4
